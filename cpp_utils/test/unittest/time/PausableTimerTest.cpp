...
#include <cpp_utils/time/PausableTimer.hpp>
...
constexpr const eprosima::utils::Duration_ms RESIDUAL_TIME = 10;
constexpr const eprosima::utils::Duration_ms TIME_WAIT_TEST = 200;
