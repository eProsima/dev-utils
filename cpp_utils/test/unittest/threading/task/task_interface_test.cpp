...
Duration_ms DEFAULT_TIME_TEST = 20u;
...
template <class Task>
threading::ITask* create_task_specialization(std::function<void()>* callback);

template <>
threading::ITask* create_task_specialization<threading::ReferenceTask>(
    std::function<void()>* callback)
{
    // Copy callback value inside new object
    return new threading::ReferenceTask(callback);
}

template <>
threading::ITask* create_task_specialization<threading::OwnedTask>(
    std::function<void()>* callback)
{
    // Copy callback value inside new object
    return new threading::OwnedTask(*callback);
}

template <>
threading::ITask* create_task_specialization<threading::ArgsOwnedTask<>>(
    std::function<void()>* callback)
{
    // Copy callback value inside new object
    return new threading::ArgsOwnedTask<>(*callback);
}

template <>
threading::ITask* create_task_specialization<threading::ArgsOwnedTask<int>>(
    std::function<void()>* callback)
{
    // Copy callback value inside new object
    return new threading::ArgsOwnedTask<int>(
...
typedef ::testing::Types<
        threading::ReferenceTask,
        threading::OwnedTask,
        threading::ArgsOwnedTask<>,
        threading::ArgsOwnedTask<int>
    > CaseTypes;
