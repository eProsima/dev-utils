...
eprosima::utils::Duration_ms DEFAULT_TIME_TEST = 1000u;
eprosima::utils::Duration_ms RESIDUAL_TIME_TEST = 10u;
eprosima::utils::Duration_ms LONG_TIME_TEST = 5000u;
    ...
    // 2
    {
        ...
        auto lambda_for_A_and_B =
                    ...
                    ()
                {
                    ...
                    catch (const eprosima::utils::DisabledException& e)
                    {
                        // Stopped by disabled
